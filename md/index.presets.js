...
window.PRESETS = {
  ...
  h2: [
    ...
    { id: 'underline',   name: '强调字重', style: 'font-size:{fs}px; font-weight:800; color:{c}; margin:28px 0 16px; line-height:1.45;' },
    { id: 'dashed',      name: '前缀短横', style: 'font-size:{fs}px; font-weight:700; color:{c}; margin:28px 0 16px; line-height:1.45;', prefix: '— ' },
  ...
  h3: [
    ...
    { id: 'dottedline',  name: '点前缀', style: 'font-size:{fs}px; font-weight:600; color:{c}; margin:22px 0 12px; line-height:1.5;', prefix: '· ' },
    { id: 'wave',        name: '柔色标签', style: 'font-size:{fs}px; font-weight:600; color:{c}; margin:22px 0 12px; display:inline-block; padding:2px 8px; background:{cbg}; border-radius:4px; line-height:1.5;' },
...
window.THEMES = {
  ...
  jingdian: {
    ...
    h3: { preset: 'leftbar', color: '#C41E3A', fontSize: 17 },
